...
<head>
   ...
   <link rel="stylesheet" href="../css/member/mem_passpage/mp_main.css">
   <link rel="stylesheet" href="../css/member/mem_passpage/mp_footer.css">
   <title>G마켓 - 로그인</title>
</head>
<style>
   @font-face {
...
<body>
   <div id="container">
      ...
      <!-- main -->
      <div class="main">
      <form action="gmMemberPassPro" method="post">
         ...
         <div class="loginbox">
            ...
            <div class="chgpass">
               <img src="../imgs/pwlogo.png">
               <input type="password" placeholder="비밀번호 수정" name="chgpass">
            </div>
