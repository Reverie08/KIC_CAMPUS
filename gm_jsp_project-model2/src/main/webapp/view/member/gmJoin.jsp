...
<link rel="stylesheet" href="${pageContext.request.contextPath }/css/createpage/cp_main.css">
...
<body>
	<div id="container">
		...
		<!-- main -->
		<div class="main">
			<form action="gmJoinPro" novalidate method="post">
				<div class="head">
				...
				<label for="trader">소비자</label><input class="trader" type="radio" name="trader" id="trader"  value="1" >
				<label for="trader">판매자</label><input class="trader" type="radio" name="trader" id="trader"  value="2" >
