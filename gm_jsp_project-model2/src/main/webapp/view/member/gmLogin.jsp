...
<link rel="stylesheet" href="${pageContext.request.contextPath }/css/loginpage/lp_main.css">
<link rel="stylesheet" href="${pageContext.request.contextPath }/css/loginpage/lp_footer.css">
<title>G마켓 - 로그인</title>
</head>
<style>
@font-face {
...
<body>
	<div id="container">
		...
		<!-- main -->
		<div class="main">
			<form action="gmLoginPro" method="post">
				<div>
				...
				<div class="loginbox">
					...
					<div class="id">
						<img src="../imgs/idlogo.png"><input type="text"
							placeholder="아이디" name="id">
					</div>
					<div class="password">
						<img src="../imgs/pwlogo.png"> <input type="password"
							placeholder="비밀번호" name="pass"> <span>비밀번호 표시</span>
					</div>
					<div class="id_save">
			...
			<div class="mini_tag">
				<table>
					<tr>
						...
						<td><a href="${pageContext.request.contextPath}/member/gmMemberPassForm">비밀번호 재설정</a></td>
						<td><a href="${pageContext.request.contextPath}/member/gmJoin">회원가입</a></td>
					</tr>
				</table>
			</div>
		</div>
