			...
			<div class="user_info">
				<ul>
					...
					<c:if test="${sessionScope.id==null }">
						<li><a
							href="${pageContext.request.contextPath}/member/gmLogin"><img
								src="../imgs/login.png"></a></li>
					</c:if>
					<c:if test="${sessionScope.id!=null }">
						<li><a
							href="${pageContext.request.contextPath}/member/gmJoinInfo"><img
								src="../imgs/login.png"></a></li>
					</c:if>
				...
				<table>
					<tbody>
						<tr>
							...
							<c:if test="${sessionScope.id!=null }">
								<td><b><a
										href="${pageContext.request.contextPath}/member/gmJoinInfo">${mem.name}님</a></b></td>
								<td><a
									href="${pageContext.request.contextPath}/member/gmLogout">로그아웃</a></td>
							</c:if>

							<td><a
								href="${pageContext.request.contextPath}/board/gmBoardList?boardid=1">고객센터</a></td>
								
								
							<c:if test="${sessionScope.id==null }">				
							<td><a href="${pageContext.request.contextPath}/product/gmProdList">Global</a></td>
							</c:if>
								
							<c:if test="${mem.trader==1 }">				
							<td><a href="${pageContext.request.contextPath}/product/gmProdList">Global</a></td>
							</c:if>
							
							<c:if test="${mem.trader==2 }">				
							<td><a href="${pageContext.request.contextPath}/product/gmProdForm">상품등록</a></td>
							</c:if>
