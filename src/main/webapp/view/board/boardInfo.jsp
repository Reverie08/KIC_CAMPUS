...
function commentPro(num) {
	...
	fetch(url+param)
	.then(res => res.text()) //우선 html을 text로 받기
	.then(txt => {
		alert(txt)
	...
	<div class="container">
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				<h4 class="mb-3 text-center">${boardName }게시물정보</h4>
				<table class="table">
					<tr>
						<td>글번호</td>
						<td>${board.num}</td>
					...
					<tr>
						<td>이미지</td>
						<td><img
							src="${pageContext.request.contextPath}/img/board/${board.file1}" /></td>
					</tr>

					<tr class="text-center">
						<td colspan="2"><a class="btn btn-primary"
							href="${pageContext.request.contextPath}/board/boardUpdateForm?num=${board.num}">글
								수정</a> <a class="btn btn-primary"
							href="${pageContext.request.contextPath}/board/boardDeleteForm?num=${board.num}">글
								삭제</a> <a class="btn btn-primary"
							href="${pageContext.request.contextPath}/board/boardList?boardid=${sessionScope.boardid}">글
								목록</a></td>
					</tr>
				</table>
				<div class="row">
