...
<div class="flex flex-col h-screen">
    ...
    <div class="flex flex-grow">
      ...
      <aside class="bg-white rounded-lg shadow p-4 fixed-sidebar">
        ...
        <ul>
          <li class="mb-2"><a href="${pageContext.request.contextPath}/anno/BusinessAnnoList" class="text-blue-500">공고목록</a></li>
          <li class="mb-2"><a href="#" class="text-blue-500">#</a></li>
          <li class="mb-2"><a href="#" class="text-blue-500">#</a></li>
          <li class="mb-2"><a href="${pageContext.request.contextPath}/anno/BusinessAnnoInsertForm" class="text-blue-500"><b>공고작성</b></a></li>
        </ul>
      </aside>
        ...
        <div class="main-content w-5/6 p-4 overflow-x-auto">
            <div class="container bg-white p-6 rounded-lg shadow-md">
                ...
                <form action="annoinsertpro" method="post">
                    <div class="form-group">
                        <label for="bName" class="form-label">기업명:</label>
                        <input type="text" id="bName" name="bName" class="form-input">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="bId" name="bId" class="form-input">
                    </div>
