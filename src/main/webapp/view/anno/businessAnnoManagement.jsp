  ...
  <div class="flex flex-col h-screen">
    ...
    <div class="flex flex-grow">
      ...
      <aside class="bg-white rounded-lg shadow p-4 fixed-sidebar">
        ...
        <ul>
          <li class="mb-2"><a href="${pageContext.request.contextPath}/anno/BusinessAnnoInfo?annoid=${anno.annoid}" class="text-blue-500">공고내용</a></li>
          <li class="mb-2"><a href="${pageContext.request.contextPath}/anno/BusinessAnnoManagement?annoid=${anno.annoid}" class="text-blue-500"><b>이력서 관리</b></a></li>
