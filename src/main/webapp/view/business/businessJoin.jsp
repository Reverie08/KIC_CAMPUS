...
<body>
    <div class="container">
        <h2>기업 회원가입</h2>
        <form action="businessjoinpro" method="post" novalidate>
            <div class="form-group">
                <label for="bid">사업자번호</label>
                <input type="text" id="bid" name="bid" placeholder="- 없이 입력하세요" required pattern="\d{1,10}">
                <div class="error-message">10자리 이내로 입력하세요</div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="bname" name="bname" placeholder="회사명" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="welfare" name="welfare" placeholder="복리후생">
            </div>
            <div class="form-group">
