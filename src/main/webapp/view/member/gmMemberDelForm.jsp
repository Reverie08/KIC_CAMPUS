...
<head>
   ...
   <link rel="stylesheet" href="../css/member/mem_delpage/md_main.css">
   <link rel="stylesheet" href="../css/member/mem_delpage/md_footer.css">
   <title>G마켓 - 로그인</title>
</head>
<style>
   @font-face {
...
<body>
   <div id="container">
      ...
      <!-- main -->
      <div class="main">
      <form action="gmMemberDelPro" method="post">
