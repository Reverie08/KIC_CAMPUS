...
<link rel="stylesheet" href="../css/loginpage/lp_main.css">
<link rel="stylesheet" href="../css/loginpage/lp_footer.css">
<title>G마켓 - 로그인</title>
</head>
<style>
@font-face {
...
<body>
	<div id="container">
		...
		<!-- main -->
		<div class="main">
			<form action="gmLoginPro.jsp" method="post">
				<div>
			...
			<div class="mini_tag">
				<table>
					<tr>
						...
						<td><a href="<%=request.getContextPath()%>/gmarket_project/gmMemberPassForm.jsp">비밀번호 재설정</a></td>
