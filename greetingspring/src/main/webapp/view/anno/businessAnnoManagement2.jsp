...
<!--                <h2 class="text-2xl font-bold mb-4">공고 수정</h2> -->
               <form action="anno-update-pro" method="post">
<%--                   <input type="text" name="annoId" value="${anno.annoId}"> --%>
                  
                  <div class="form-group"></div>
                  <div class="form-group">
                     <label for="businessName" class="form-label">기업명:</label> <input
                        type="text" id="businessName" name="businessName"
                        value="${anno.businessName}" class="form-input">
                  </div>

                  <div class="form-group">
                     <label for="annoContent" class="form-label">복지:</label>
                  ...
                  <div class="form-group">
                     <label for="annoPickNum" class="form-label">채용 인원:</label> <input
                        ...
                        value="${anno.annoPickNum}" class="form-input">
                  </div>

                  <div class="form-group">
                     <label for="annoContent" class="form-label">공고 내용:</label>
                     <textarea id="annoContent" name="annoContent"
                        class="form-textarea">${anno.annoContent}</textarea>
                  </div>
                  ...
                  <div class="form-group">
                     <label for="annoDeadline" class="form-label">지원 마감:</label> <input
                        ...
                        value="${annoDeadlineStr}" class="form-input">
                  </div>
